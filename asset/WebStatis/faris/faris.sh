...
cd /var/www/html/ && git clone https://github.com/iniciloo/company-faris.git

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/html/company-faris/
...
cp /var/www/html/company-faris/shell/000-default.conf .
