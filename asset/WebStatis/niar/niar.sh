...
cd /var/www/html/ && git clone https://github.com/iniciloo/company-niar.git

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/html/company-niar/
...
cp /var/www/html/company-niar/shell/000-default.conf .
...
sudo rsync -avR --stats /var/www/company-niar /ebs-ubuntu