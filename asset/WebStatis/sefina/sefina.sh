...
cd /var/www/html/ && git clone https://github.com/iniciloo/company-sefina.git

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/html/company-sefina/
...
cp /var/www/html/company-sefina/shell/000-default.conf .
